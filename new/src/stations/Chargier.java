...
public class Chargier {
	...
	public void startLineToTable(boolean direction) throws RemoteException {				// start line from car to table if direction true turn forword
	...
	public void startLineToStore(boolean direction) throws RemoteException {  	// start line from Table to Store if direction true turn forword
